...
let githubLink = "http://github.com/janno-p/XRoadLib"

// Specify more information about your project
let info =
  [ "project-name", "XRoadLib"
    "project-author", "Janno Põldma"
    "project-summary", "A .NET library for implementing service interfaces of X-Road providers using Code-First Development approach."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/XRoadLib" ]
