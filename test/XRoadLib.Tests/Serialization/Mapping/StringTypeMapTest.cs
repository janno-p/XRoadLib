...
namespace XRoadLib.Tests.Serialization.Mapping
{
    public class StringTypeMapTest : TypeMapTestBase
    {
        ...
        [Fact]
        public void CanSerializeStringValueWithEncodedSpecialCharacters()
        {
        ...
        [Fact]
        public void CanSerializeStringValueWithEncodedCDataCharacters()
        {
        ...
        [Fact]
        public void CanSerializeStringValueWithCDataSpecialCharacters()
        {
        ...
        [Fact]
        public void CanSerializeStringValueWithCDataInceptionCharacters()
        {
