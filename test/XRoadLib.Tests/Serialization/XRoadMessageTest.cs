...
namespace XRoadLib.Tests.Serialization
{
    public class XRoadMessageTest
    {
        ...
        public void CanReadEmptyContentWithoutAttachments()
        {
            ...
            using var reader = new XRoadMessageReader(stream, MessageFormatter, "text/xml; charset=UTF-8", Path.GetTempPath(), _serviceManagers);
        ...
        public void CanReadContentWithAttachments()
        {
            ...
            using var reader = new XRoadMessageReader(stream, MessageFormatter, contentTypeHeader, Path.GetTempPath(), _serviceManagers);
            using var message = new XRoadMessage();
