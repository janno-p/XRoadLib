...
Target "InstallDotnet" (fun _ ->
    let dotnetPath = DotNetCli.InstallDotNetSDK "2.1.4"
    let envPath = environVarOrDefault "PATH" ""
    setProcessEnvironVar "PATH" (String.Join(String(Path.PathSeparator, 1), [ dotnetPath; envPath ]))
)
...
Target "RunTests" (fun _ ->
    ...
    |> Seq.iter (fun proj ->
        ...
        DotNetCli.RunCommand
            (fun p -> { p with WorkingDir = DirectoryName proj })
            "xunit")
)
