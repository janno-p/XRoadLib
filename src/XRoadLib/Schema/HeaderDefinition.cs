...
public class HeaderDefinition
{
    ...
    private sealed class HeaderDefinitionBuilder<THeader> : IHeaderDefinitionBuilder<THeader> where THeader : IXRoadHeader
    {
    ...
    private sealed class XNameComparer : IComparer<XName>
    {
