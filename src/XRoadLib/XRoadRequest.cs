...
namespace XRoadLib
{
    public class XRoadRequest<THeader> where THeader : IXRoadHeader
    {
        private readonly IProtocol<THeader> protocol;
        private readonly THeader header;
        private readonly XName operationName;

        public IDictionary<string, object> Parameters { get; } = new Dictionary<string, object>();

        public XRoadRequest(IProtocol<THeader> protocol, THeader header, XName operationName)
        {
            this.header = header;
