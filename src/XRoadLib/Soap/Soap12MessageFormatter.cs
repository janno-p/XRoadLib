...
public class Soap12MessageFormatter : IMessageFormatter
{
    ...
    public IFault CreateFault(Exception exception)
    {
        return new Soap12Fault
        {
            ...
            {
                Value = Soap12FaultCodeValue.Receiver,
    ...
    private static Task WriteSoapFaultValueEnumAsync(XmlWriter writer, Soap12FaultCodeValue value) => value switch
    {
        Soap12FaultCodeValue.Receiver => writer.WriteQualifiedNameAsync("Receiver", NamespaceConstants.Soap12Env),
        Soap12FaultCodeValue.Sender => writer.WriteQualifiedNameAsync("Sender", NamespaceConstants.Soap12Env),
        Soap12FaultCodeValue.MustUnderstand => writer.WriteQualifiedNameAsync("MustUnderstand", NamespaceConstants.Soap12Env),
        Soap12FaultCodeValue.VersionMismatch => writer.WriteQualifiedNameAsync("VersionMismatch", NamespaceConstants.Soap12Env),
        Soap12FaultCodeValue.DataEncodingUnknown => writer.WriteQualifiedNameAsync("DataEncodingUnknown", NamespaceConstants.Soap12Env),
        Soap12FaultCodeValue.None or _ => throw new ArgumentException($"Invalid SOAP 1.2 Fault Code enumeration value `{value}`.", nameof(value))
    };
    ...
    private static Soap12FaultCodeValue DeserializeFaultCodeValue(XmlReader reader)
    {
        ...
        if (!enumName.NamespaceName.Equals(NamespaceConstants.Soap12Env))
            return Soap12FaultCodeValue.None;

        return enumName.LocalName switch
        {
            "DataEncodingUnknown" => Soap12FaultCodeValue.DataEncodingUnknown,
            "MustUnderstand" => Soap12FaultCodeValue.MustUnderstand,
            "Receiver" => Soap12FaultCodeValue.Receiver,
            "Sender" => Soap12FaultCodeValue.Sender,
            "VersionMismatch" => Soap12FaultCodeValue.VersionMismatch,
            _ => Soap12FaultCodeValue.None
        };
    }
