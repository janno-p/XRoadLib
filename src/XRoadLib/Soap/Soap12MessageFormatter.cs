...
namespace XRoadLib.Soap
{
    ...
    {
        private static readonly XName envelopeName = XName.Get("Envelope", NamespaceConstants.SOAP12_ENV);
        private static readonly XName headerName = XName.Get("Header", NamespaceConstants.SOAP12_ENV);
        private static readonly XName bodyName = XName.Get("Body", NamespaceConstants.SOAP12_ENV);
