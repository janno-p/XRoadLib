...
namespace XRoadLib.Protocol
{
    public class XRoadHeader
    {
        ...
        public XRoadCentralServiceIdentifier CentralService { get; } // Optional
        ...
        public string UserId { get; } // Optional
        ...
        public string Issue { get; } // Optional
