...
namespace XRoadLib.Headers
{
    ...
    public interface IXRoadHeader40
    {
        ...
        /// </summary>
        [XmlElement("id", Namespace = NamespaceConstants.XRoadV4)]
        string Id { get; }
        ...
        /// </summary>
        [XmlElement("userId", Namespace = NamespaceConstants.XRoadV4)]
