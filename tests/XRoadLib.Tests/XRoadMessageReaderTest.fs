...
module XRoadHeaderV40Tests =
    ...
    let ``collects client mandatory values`` () =
        let xrh,_,pr = parseHeader (minimalValidHeader "") NamespaceConstants.XROAD_V4
    ...
    let ``collects unqualified soap header elements, but cannot detect protocol version`` () =
        let xrh,uhs,pr = parseHeader @"<x><test>bla</test></x><y /><z />" NamespaceConstants.XROAD_V4
        xrh |> should be Null
        pr |> should equal XRoadProtocol.Undefined
    ...
    let ``collects unqualified soap headers that are mixed with X-Road elements`` () =
        let xrh,uhs,pr = parseHeader @"<x /><xrd:client id:objectType=""MEMBER""><id:xRoadInstance>EE</id:xRoadInstance><id:memberClass>GOV</id:memberClass><id:memberCode>12345</id:memberCode></xrd:client><y /><xrd:id>ABCDE</xrd:id><xrd:protocolVersion>4.0</xrd:protocolVersion><z />" NamespaceConstants.XROAD_V4
        xrh |> should not' (be Null)
        pr |> should equal XRoadProtocol.Version40
        xrh.Client |> should not' (be Null)
        xrh.Client.XRoadInstance |> should equal "EE"
    ...
    let ``unrecognized X-Road header element`` () =
        TestDelegate(fun _ -> parseHeader @"<xrd:x />" NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``empty service element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:service />") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``missing objectType attribute for service element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:service></xrd:service>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``missing xRoadInstance element for service element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:service id:objectType=""SERVICE""></xrd:service>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``invalid element in service element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:service id:objectType=""SERVICE""><x /></xrd:service>") NamespaceConstants.XROAD_V4 |> ignore)
        |> should (throwWithMessage "Element `http://x-road.eu/xsd/xroad.xsd:service` must have child element `http://x-road.eu/xsd/identifiers:xRoadInstance`.") typeof<XRoadException>

    [<Test>]
    let ``missing memberClass element for service element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:service id:objectType=""SERVICE""><id:xRoadInstance /></xrd:service>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``missing memberCode element for service element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:service id:objectType=""SERVICE""><id:xRoadInstance /><id:memberClass /></xrd:service>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``missing serviceCode element for service element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:service id:objectType=""SERVICE""><id:xRoadInstance /><id:memberClass /><id:memberCode /></xrd:service>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``read minimal group of elements for service element`` () =
        let xhr,_,_ = parseHeader (minimalValidHeader @"<xrd:service id:objectType=""SERVICE""><id:xRoadInstance /><id:memberClass /><id:memberCode /><id:serviceCode /></xrd:service>") NamespaceConstants.XROAD_V4
    ...
    let ``read all elements for service element`` () =
        let xhr,_,_ = parseHeader (minimalValidHeader @"<xrd:service id:objectType=""SERVICE""><id:xRoadInstance /><id:memberClass /><id:memberCode /><id:subsystemCode /><id:serviceCode /><id:serviceVersion /></xrd:service>") NamespaceConstants.XROAD_V4
        xhr |> should not' (be Null)
        xhr.Service |> should not' (be Null)
        xhr.Service.XRoadInstance |> should equal ""
        xhr.Service.MemberClass |> should equal ""
    ...
    let ``optional parameter at wrong position for service element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:service id:objectType=""SERVICE""><id:xRoadInstance /><id:memberClass /><id:memberCode /><id:serviceCode /><id:subsystemCode /></xrd:service>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``read simple optional element values`` () =
        let xhr,_,_ = parseHeader (minimalValidHeader @"<xrd:userId>Kalle</xrd:userId><xrd:issue>TOIMIK</xrd:issue>") NamespaceConstants.XROAD_V4
        xhr |> should not' (be Null)
    ...
    let ``empty centralService element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:centralService />") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``missing objectType attribute for centralService element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:centralService></xrd:centralService>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``missing xRoadInstance element for centralService element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:centralService id:objectType=""CENTRALSERVICE""></xrd:centralService>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``missing serviceCode element for centralService element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<xrd:centralService id:objectType=""CENTRALSERVICE""><id:xRoadInstance /></xrd:centralService>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``valid centralService element`` () =
        let xhr,_,_ = parseHeader (minimalValidHeader @"<xrd:centralService id:objectType=""CENTRALSERVICE""><id:xRoadInstance>FI</id:xRoadInstance><id:serviceCode>fun</id:serviceCode></xrd:centralService>") NamespaceConstants.XROAD_V4
        xhr |> should not' (be Null)
    ...
    let ``emtpy representedParty element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<repr:representedParty />") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``element partyCode is required for representedParty element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<repr:representedParty></repr:representedParty>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``wrong element order for representedParty element`` () =
        TestDelegate(fun _ -> parseHeader (minimalValidHeader @"<repr:representedParty><repr:partyCode /><repr:partyClass /></repr:representedParty>") NamespaceConstants.XROAD_V4 |> ignore)
    ...
    let ``can handle missing optional element for representedParty element`` () =
        let xhr,_,_ = parseHeader (minimalValidHeader @"<repr:representedParty><repr:partyCode /></repr:representedParty>") NamespaceConstants.XROAD_V4
        xhr |> should not' (be Null)
        xhr |> should be instanceOfType<XRoadLib.Header.IXRoadHeader40>
        let xhr4 = xhr :?> XRoadLib.Header.IXRoadHeader40
    ...
    let ``can handle optional element value for representedParty element`` () =
        let xhr,_,_ = parseHeader (minimalValidHeader @"<repr:representedParty><repr:partyClass>CLS</repr:partyClass><repr:partyCode>COD</repr:partyCode></repr:representedParty>") NamespaceConstants.XROAD_V4
        xhr |> should not' (be Null)
        xhr |> should be instanceOfType<XRoadLib.Header.IXRoadHeader40>
        let xhr4 = xhr :?> XRoadLib.Header.IXRoadHeader40
        xhr4.RepresentedParty |> should not' (be Null)
    ...
    let ``recognizes v4.0 protocol from representedParty element`` () =
        TestDelegate(fun _ -> parseHeader @"<repr:representedParty><repr:partyClass>CLS</repr:partyClass><repr:partyCode>COD</repr:partyCode></repr:representedParty>" NamespaceConstants.XROAD_V4 |> ignore)
        |> should (throwWithMessage "X-Road header `client` element is mandatory.") typeof<XRoadException>
